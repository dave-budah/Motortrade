<x-admin-layout>
    <div class="card">
        <div class="title" style="margin-top: 5rem">
            <h3 class="page-title">Create Vehicle</h3>
        </div>

        <div class="table-card cardForm">
            <form method="POST" action="{{ route('admin.vehicles.store') }}" class="small-form" id="small-form">
                @csrf
                @method('POST')
                <div class="text-center">
                    <h1 class="form_title text-uppercase">Create Vehicle</h1>
                </div>
